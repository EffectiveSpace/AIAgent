...
class Smart_AI_Arduino_Interface:
    def __init__(self, arduino_port='COM3', baudrate=9600, ollama_url="http://localhost:11434/api/generate", use_local_ollama=True, model="llama3"):
        ...
        self.commands = {
            ...
            'get_old_sensor': {'command': 0x04, 'params': []},
            ...
            'set_auto_mode': {'command': 0x0A, 'params': [0]}  # 0=выкл, 1=вкл
        }
...
if __name__ == "__main__":
    ...
    time.sleep(2)
    interface.process_request("What is the light level?")
    time.sleep(2)
    interface.process_request("Rotate servo to 45 degrees")
    time.sleep(2)
