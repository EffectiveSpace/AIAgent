...
class Advanced_AI_Arduino_Interface:
    def __init__(self, arduino_port='COM3', baudrate=9600, ollama_url="http://localhost:11434/api/generate", use_local_ollama=True, model="llama3"):
        ...
        self.commands = {
            ...
            'set_servo_angle': {
                'command': 0x05,
                'params': [90],  # по умолчанию 90 градусов
...
if __name__ == "__main__":
    ...
    time.sleep(2)
    interface.process_request_with_tools("Rotate servo to 90 degrees")
    time.sleep(3)
    interface.process_request_with_tools("Rotate servo to 180 degrees")
    time.sleep(3)
    interface.process_request_with_tools("Rotate servo to 0 degrees")
    time.sleep(3)
    interface.process_request_with_tools("Turn off the LED")
    time.sleep(2)
    interface.process_request_with_tools("What is the current servo angle?")
